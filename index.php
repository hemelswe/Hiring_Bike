      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>We have more than a thousand bikes. </p>
             </div>
        </div>
      </div>
    </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>The bikes can be picked up and returned in the participating cities. Just send the identification number of the bike you would like to use at the station terminal, via nextbike-app or via the hotline 01743330010 and you will receive a code for opening the lock. Simply return the bike at one of the official VRNnextbike rental stations., thanks to our multilingual team! At the same price you would pay on the spot! We have best bikes with best deals</p>
    </div>
    <div class="row">
